...
void PlotProtonCorr(){
  ...
  TH1F *frame = new TH1F("frame","frame",1,0,80);
   ...
   TLegend *leg2 = new TLegend(0.172819,0.710106,0.375839,0.960106);//0.753356,0.168449,0.956376,0.491979);//0.17,0.461197,0.3725,0.868071);//0.461918,1.116760.6125,0.657428,0.815833,0.956763);//0.611481,0.537099,0.896839,0.89701,NULL,"brNDC");
...
leg2->SetFillColor(0);
leg2->SetFillStyle(0);
 leg2->AddEntry(graph[0],"#sqrt{s_{NN}}=7.7 GeV","P");
 leg2->AddEntry(graph[1],"#sqrt{s_{NN}}=11.5 GeV","P");
 leg2->AddEntry(graph[2],"#sqrt{s_{NN}}=19.6 GeV","P");
 leg2->AddEntry(graph[3],"#sqrt{s_{NN}}=27 GeV","P");
 TLegend *leg3 = new TLegend(0.43311,0.710106,0.635452,0.960106);//0.172819,0.176471,0.375839,0.395722);//0.753356,0.168449,0.956376,0.491979);//0.17,0.461197,0.3725,0.868071);//0.461918,1.116760.6125,0.657428,0.815833,0.956763);//0.611481,0.537099,0.896839,0.89701,NULL,"brNDC");
...
leg3->SetFillColor(0);
leg3->SetFillStyle(0);
 leg3->AddEntry(graph[4],"#sqrt{s_{NN}}=39 GeV","P");
 leg3->AddEntry(graph[5],"#sqrt{s_{NN}}=62.4 GeV","P");
 leg3->AddEntry(graph[6],"#sqrt{s_{NN}}=130 GeV","P");
 leg3->AddEntry(graph[7],"#sqrt{s_{NN}}=200 GeV","P");
 leg2->Draw();
 leg3->Draw();
 ...
 lineHigh->SetLineColor(1);
  TH1F *frame2 = new TH1F("frame2","frame2",200,xlow,xhigh);
   ...
   TLegend *leg4 = new TLegend(0.692308,0.819149,0.896321,0.968085);//0.43311,0.710106,0.635452,0.960106);//0.172819,0.176471,0.375839,0.395722);//0.753356,0.168449,0.956376,0.491979);//0.17,0.461197,0.3725,0.868071);//0.461918,1.116760.6125,0.657428,0.815833,0.956763);//0.611481,0.537099,0.896839,0.89701,NULL,"brNDC");
