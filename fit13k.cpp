...
Double_t avgET=0.0;
		...
		//EXPO->SetParLimits(0,1.5,2);
		//EXPO->SetParLimits(1,0.,0.3);
		...
		EXPO2->SetParNames("A2","B2","C2","mass","type");
			EXPO2->SetParLimits(0,8,9.017);//A
		EXPO2->SetParLimits(1,-0.3742,-0.2);//B
		EXPO2->SetParLimits(2,0.2,0.2837);//C
...
Double_t dETdEtaTErrE2 = dETdEtaLErrE2+dETdEta_d_errE2+dETdEtaRErrE2;
	...
	avgET=(dETdEtaTotalE+dETdEtaTotalE2)/2.0;
		...
		avg <<collEn << "\t"
		    ...
		    << avgETy_err <<  "\t"
		    << avgETyfitErr <<  "\n";
	string imgPathAndName = "./Table1/13TeVK.png";
