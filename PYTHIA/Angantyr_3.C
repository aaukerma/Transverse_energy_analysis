...
************/
  ...
  char *filename4 = Form("%i_%iGeV_DECAY_ANALYSIS.txt",jobID,modSNN);
  ...
  out3<<"Decay Branching Ratios (eta and omega)\n******************************************************\n";
...
***********************/
  for ( int event = 0; event < nEvents; ++event ) {
    ...
    **************************/
    ...
    if(debug)cout << "4 ";             //DEBUG STATEMENT
    Event TheEvent = pythia.event;
    int npart = TheEvent.size();
    //cout<<npart<<endl;

    /****************************************
    Particle Parent and Decay Chain Structure
    *****************************************/
    if(debug)cout << "4.2 ";             //DEBUG STATEMENT
    ...
    *****************************************/
    if(debug)cout << "6 ";             //DEBUG STATEMENT
...
**************/
  ...
  out3<<"  mode\t\tfraction\texpected [Particle Physics Booklet 2018]\n";
  out3<<"--------------eta Decay Branching Ratios-----------------\n";
  out3<<"  2gamma\t\t"<<ETADECAYS[0]<<"%\t 39.41%\n";
  out3<<"  3pi0\t\t"<<ETADECAYS[1]<<"%\t 32.68%\n";
  out3<<"  pi+,pi-,pi0\t\t"<<ETADECAYS[2]<<"%\t 22.92%\n";
  out3<<"  pi+,pi-,gamma\t\t"<<ETADECAYS[3]<<"%\t 4.22%\n";
  out3<<"  e+,e-,gamma\t\t"<<ETADECAYS[4]<<"%\t 6.9E-3%\n";
  out3<<"  mu+,mu-,gamma\t\t"<<ETADECAYS[5]<<"%\t 3.1E-4%\n";
  out3<<"  pi0,2gamma\t\t"<<ETADECAYS[6]<<"%\t 2.56E-4%\n";
  out3<<"  2pi0,2gamma\t\t"<<ETADECAYS[7]<<"%\t <1.2E-3%\n";
  out3<<"  4gamma\t\t"<<ETADECAYS[8]<<"%\t <2.8E-4%\n";
  out3<<"  e+,e-\t\t"<<ETADECAYS[9]<<"%\t <2.3E-6%\n";
  out3<<"  mu+,mu-\t\t"<<ETADECAYS[10]<<"%\t 5.8E-6%\n";
  out3<<"  2e+,2e-\t\t"<<ETADECAYS[11]<<"%\t 2.4E-5%\n";
  out3<<"  pi+,pi-,e+,e-,(gamma)\t\t"<<ETADECAYS[12]<<"%\t 2.68E-4%\n";
  out3<<"  e+,e-,mu+,mu-\t\t"<<ETADECAYS[13]<<"%\t <1.6E-4%\n";
  out3<<"  2mu+,2mu-\t\t"<<ETADECAYS[14]<<"%\t <3.6E-4%\n";
  out3<<"  [OTHER]\t\t"<<ETADECAYS[15]<<"%\t -------%\n";
  out3<<"--------------omega Decay Branching Ratios-----------------\n";
  out3<<"  pi+,pi-,pi0\t\t"<<OMEGADECAYS[0]<<"%\t 89.2%\n";
  out3<<"  pi0,gamma\t\t"<<OMEGADECAYS[1]<<"%\t 8.40%\n";
  out3<<"  pi+,pi-\t\t"<<OMEGADECAYS[2]<<"%\t 1.53%\n";
  out3<<"  eta,gamma\t\t"<<OMEGADECAYS[3]<<"%\t 4.5E-4%\n";
  out3<<"  pi0,e+,e-\t\t"<<OMEGADECAYS[4]<<"%\t 7.7E-4%\n";
  out3<<"  pi0,mu+,mu-\t\t"<<OMEGADECAYS[5]<<"%\t 1.34E-4%\n";
  out3<<"  e+,e-\t\t"<<OMEGADECAYS[6]<<"%\t 7.36E-5%\n";
  out3<<"  pi+,pi-,2pi0\t\t"<<OMEGADECAYS[7]<<"%\t <2E-4%\n";
  out3<<"  pi+,pi-,gamma\t\t"<<OMEGADECAYS[8]<<"%\t <3.6E-3%\n";
  out3<<"  2pi+,2pi-\t\t"<<OMEGADECAYS[9]<<"%\t <1E-3%\n";
  out3<<"  2pi0,gamma\t\t"<<OMEGADECAYS[10]<<"%\t 6.7E-5%\n";
  out3<<"  eta,pi0,gamma\t\t"<<OMEGADECAYS[11]<<"%\t <3.3E-5%\n";
  out3<<"  mu+,mu-\t\t"<<OMEGADECAYS[12]<<"%\t 7.4E-5%\n";
  out3<<"  3gamma\t\t"<<OMEGADECAYS[13]<<"%\t <1.9E-4%\n";
  out3<<"  [OTHER]\t\t"<<OMEGADECAYS[14]<<"%\t -------%\n";
