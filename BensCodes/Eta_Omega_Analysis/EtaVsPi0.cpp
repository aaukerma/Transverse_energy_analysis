...
*/
  ...
  TCanvas *c1 = new TCanvas("c1","Au+Au Central", 215,111,1204,928);
  ...
  TLegend* legend=new TLegend(.64975,.541528,.895175,.895903);
  ...
  TGraph* gr7=new TGraph(n6,x7,y7);
    gr7->SetTitle(" #frac{#eta}{#pi^{0}} Ratio at #sqrt{S_{NN}}=200GeV;p_{T}; #eta/#pi^{0}");
