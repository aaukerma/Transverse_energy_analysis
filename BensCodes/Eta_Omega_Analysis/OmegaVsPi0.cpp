...
double ErrorBuilder(double ptA, double ratio){
  ...
  vector<double> e0{2.31657e-01, 9.60156e-03, 2.72294e-02, 6.21560e-02, 1.32981e-01, 2.26538e+00, 6.64944e-01};
  vector<double> e1{1.43492e-01, 9.41344e-02, 1.53131e-01, 2.52255e-01, 3.49523e-01, 4.64656e-01, 3.27781e+00};
  double test=0;
  double x0;
  double x1;
  double comp=0;
