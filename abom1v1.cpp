...
TFile* myFile = TFile::Open("HEPData-ins885104-v1-Table_1.root");

TDirectory* dir = myFile->GetDirectory("Table 1");
TH1D* h=(TH1D* )myFile->Get("Table 1/Hist1D_y2");
...
Double_t avgET=0.0;
		...
		EXPO2->SetParLimits(1,-4.0,0.0408);//B
	...
	avgET=(dETdEtaTotalE+dETdEtaTotalE2)/2.0;
		...
		avg <<collEn << "\t"
		 << mass << "\t"
		    ...
		    << avgETy_err <<  "\t"
		    << avgETyfitErr <<  "\n";
	string imgPathAndName = "./Table1/"+histoName+".png";
